...
<<<<<<< HEAD
        ...
        <script>
        setTimeout(function(){
                window.location.href = "{{ url('/princi') }}";
            }, 5000);
         </script>
...
=======
>>>>>>> ddb9fd9bfcede08d4e91bf5303554a3bb99430c3
       
    </head>
    <body class="antialiased bg-cover bg-center font-jolly " style="background-image: url('{{asset('images/blackhole.webp')}}');">
    
    <div class="relative min-h-screen bg-dots-darker bg-center selection:bg-red-500 selection:text-white">
...
<body class="antialiased bg-cover bg-center font-jolly "
    style="background-image: url('{{ asset('images/blackhole.webp') }}');">
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 text-right  w-full bg-white">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="font-semibold text-base text-gray-600 mr-12 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-hoverpri">LIMBO</a>
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold text-base text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-hoverpri">INICIAR
                        SESION</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:hoverpri">REGISTRARTE</a>
                    @endif
                @endauth
            </div>
        @endif
